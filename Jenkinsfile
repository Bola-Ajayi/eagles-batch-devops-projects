...
pipeline {
    ...
    stage('SonarQube Scan') {
      steps {
        sh """mvn sonar:sonar \
              ...
              -Dsonar.host.url=http://172.31.15.8:9000 \
              -Dsonar.login=eea99ad04a9c1f8fb0ef87afade1c88e062fd563"""
      }
    }
  ...
  post {
    always {
        ...
        slackSend channel: '#oa-cicd-pipeline-alerts', //update and provide your channel name
